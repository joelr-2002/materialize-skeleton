...
;(function ($) {
  ...
  var Skeleton = function (_Component22) {
    _inherits(Skeleton, _Component22);
    ...
    function Skeleton(el, options) {
      ...
      var _this73 = _possibleConstructorReturn(this, (Skeleton.__proto__ || Object.getPrototypeOf(Skeleton)).call(this, Skeleton, el, options));

      _this73.el.M_Skeleton = _this73;

      /**
       * Options for the skeleton
       */
      _this73.options = $.extend({}, Skeleton.defaults, options);

      _this73._setupSkeleton();
      return _this73;
    }
    ...
    _createClass(Skeleton, [{
      ...
      key: "_setupSkeleton",
      value: function _setupSkeleton() {
        this.$el.addClass('skeleton');
      }
    }], [{
      key: "init",
      value: function init(els, options) {
        return _get(Skeleton.__proto__ || Object.getPrototypeOf(Skeleton), "init", this).call(this, this, els, options);
      }
